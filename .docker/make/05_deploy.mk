...
deploy-app-boot: ## Initialize the application in the specified environment.
	$(KAMAL) app boot $(KAMAL_FLAGS)
.PHONY: deploy-app-boot
...
deploy-app-remove: ## Remove the application from the specified environment.
	$(KAMAL) app remove $(KAMAL_FLAGS)
.PHONY: deploy-app-remove
